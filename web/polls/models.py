...
class NewsInfoTable(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'news_info_table'


class NewsLatentSpaceTable(models.Model):
    news_id = models.AutoField(primary_key=True)
    latent_space = models.TextField()

    class Meta:
        managed = False
        db_table = 'news_latent_space_table'


class PreprocessedNewsTable(models.Model):
    news_id = models.AutoField(primary_key=True)
    preprocessed_content = models.TextField()

    class Meta:
        managed = False
        db_table = 'preprocessed_news_table'


class UserNewsTable(models.Model):
